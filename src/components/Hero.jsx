...
function ProfilePhoto() {
  ...
  return (
    <div className="group relative w-fit">
      <div className="absolute -inset-6 rounded-full bg-gradient-to-tr from-indigo-600/30 to-cyan-400/30 blur-2xl transition-opacity duration-500 group-hover:opacity-100 sm:opacity-80" />
      <div className="relative rounded-full bg-gradient-to-tr from-indigo-500 via-sky-500 to-cyan-400 p-1.5 shadow-2xl shadow-indigo-500/20">
        {failed ? (
      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-16 px-6 py-32 lg:grid-cols-5">
        ...
        <Reveal delay={300}>
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <a
              href="#projects"
              className="group inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-indigo-500 to-cyan-500 px-6 py-3 font-semibold text-white shadow-lg shadow-indigo-500/25 transition-transform hover:scale-105"
            >
              View My Projects
